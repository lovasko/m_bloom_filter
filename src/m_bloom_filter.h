...
int m_bloom_filter_init(struct m_bloom_filter* bf, uint32_t n, float err);
int m_bloom_filter_free(struct m_bloom_filter* bf);
int m_bloom_filter_dup(struct m_bloom_filter* dup_bf, struct m_bloom_filter* orig_bf);
int m_bloom_filter_add(struct m_bloom_filter* bf, void* data, size_t size);
int m_bloom_filter_test(struct m_bloom_filter* bf, void* data, size_t size);
